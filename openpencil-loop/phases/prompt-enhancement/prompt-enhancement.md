...
Each screen file follows the full enhancement pipeline independently: DESIGN SYSTEM → PAGE SKELETON → SECTION CONTENT → VISUAL NOTES. File naming follows the `openpencil-loop` baton convention for ordered screen progression.
