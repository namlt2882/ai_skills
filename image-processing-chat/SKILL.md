...
| **Qwen3.5 Plus** | `bailian/qwen3.5-plus` | Advanced multimodal capabilities | General purpose tasks |
| **Qwen3 Max 2026-01-23** | `bailian/qwen3-max-2026-01-23` | High intelligence, large context | Complex reasoning tasks |
...
| Qwen3.5 Plus | `bailian/qwen3.5-plus` | 20MB | 128K+ | Fast | Medium | General purpose |
| Qwen3 Max 2026-01-23 | `bailian/qwen3-max-2026-01-23` | 20MB | 1M+ | Medium | High | Complex reasoning |
| **Zhipu AI Extended Models** |
| GLM-5 | `bailian/glm-5` | 20MB | 1M | Medium | Medium | Advanced reasoning |
| **Moonshot AI Models** |
| Kimi K2.5 | `bailian/kimi-k2.5` | 20MB | 1M+ | Medium | High | Large context processing |
